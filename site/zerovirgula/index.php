...
<meta name="theme-color" content="#563d7c">
    ...
    <link href="/estilo/normalize.css" rel="stylesheet">
  <script type="text/javascript" src="chrome-extension://pbichgopagjidnkeaablhiediibgbmec/reside.js?host=comparador.escolhasegura.com.br"></script><style type="text/css">/* Chart.js */
@-webkit-keyframes chartjs-render-animation{from{opacity:0.99}to{opacity:1}}@keyframes chartjs-render-animation{from{opacity:0.99}to{opacity:1}}.chartjs-render-monitor{-webkit-animation:chartjs-render-animation 0.001s;animation:chartjs-render-animation 0.001s;}</style></head>
  <body>
    <nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
  <a class="navbar-brand col-md-3 col-lg-2 mr-0 px-3" href="#">Zero Virgula</a>
        ...
        <ul class="nav flex-column">
          <li class="nav-item">
            <a class="nav-link active" href="#">
              ...
              Zero Virgula  <span class="sr-only">(current)</span>
            </a>
          </li>
          <li class="nav-item">
...
<span style="z-index: 2147483647;"></span></body><evlist></evlist></html>
